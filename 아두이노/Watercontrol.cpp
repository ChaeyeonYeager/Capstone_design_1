...
/*
    주의 사항
    1. DC 펌프와 체크 밸브는 전자식으로 작동
    2. DC 펌프는 물이 유량계를 지나지 않도록 체크 밸브를 닫은 후에 작동해야 합니다.
    3. 유량 센서는 펄스 신호를 발생시키며, 이 신호를 통해 물의 양을 측정합니다.
    4. 유량 센서의 펄스 수를 카운트하여 목표 물 양에 도달했는지 확인합니다.
    5. 물 투입이 완료되면 체크 밸브(수동 부품)를 닫고, DC 펌프를 끕니다.
    6. 물 투입이 완료된 후에는 사료를 불리기 위해 대기합니다.
    7. 사료 불림 대기 시간은 10분으로 설정되어 있습니다.
*/  
